...
action_server_interface__action__GoTo_Goal__init(action_server_interface__action__GoTo_Goal * msg)
{
  ...
  if (!geometry_msgs__msg__Pose2D__init(&msg->pose)) {
    action_server_interface__action__GoTo_Goal__fini(msg);
    return false;
  }
  return true;
}
...
action_server_interface__action__GoTo_Goal__create()
{
  ...
  action_server_interface__action__GoTo_Goal * msg = (action_server_interface__action__GoTo_Goal *)allocator.allocate(sizeof(action_server_interface__action__GoTo_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_server_interface__action__GoTo_Goal));
  bool success = action_server_interface__action__GoTo_Goal__init(msg);
  if (!success) {
...
action_server_interface__action__GoTo_Goal__Sequence__init(action_server_interface__action__GoTo_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_Goal * data = NULL;

  if (size) {
    data = (action_server_interface__action__GoTo_Goal *)allocator.zero_allocate(size, sizeof(action_server_interface__action__GoTo_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_server_interface__action__GoTo_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        action_server_interface__action__GoTo_Goal__fini(&data[i - 1]);
      }
...
action_server_interface__action__GoTo_Goal__Sequence__fini(action_server_interface__action__GoTo_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      action_server_interface__action__GoTo_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_Goal__Sequence * array = (action_server_interface__action__GoTo_Goal__Sequence *)allocator.allocate(sizeof(action_server_interface__action__GoTo_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_server_interface__action__GoTo_Goal__Sequence__init(array, size);
  if (!success) {
...
action_server_interface__action__GoTo_Goal__Sequence__destroy(action_server_interface__action__GoTo_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_server_interface__action__GoTo_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_server_interface__action__GoTo_Goal__Sequence__are_equal(const action_server_interface__action__GoTo_Goal__Sequence * lhs, const action_server_interface__action__GoTo_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_server_interface__action__GoTo_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_server_interface__action__GoTo_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_server_interface__action__GoTo_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_server_interface__action__GoTo_Goal * data =
      (action_server_interface__action__GoTo_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_server_interface__action__GoTo_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          action_server_interface__action__GoTo_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!action_server_interface__action__GoTo_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_Result * msg = (action_server_interface__action__GoTo_Result *)allocator.allocate(sizeof(action_server_interface__action__GoTo_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_server_interface__action__GoTo_Result));
  bool success = action_server_interface__action__GoTo_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_Result__destroy(action_server_interface__action__GoTo_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    action_server_interface__action__GoTo_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
action_server_interface__action__GoTo_Result__Sequence__init(action_server_interface__action__GoTo_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_Result * data = NULL;

  if (size) {
    data = (action_server_interface__action__GoTo_Result *)allocator.zero_allocate(size, sizeof(action_server_interface__action__GoTo_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_server_interface__action__GoTo_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        action_server_interface__action__GoTo_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
action_server_interface__action__GoTo_Result__Sequence__fini(action_server_interface__action__GoTo_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      action_server_interface__action__GoTo_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_Result__Sequence * array = (action_server_interface__action__GoTo_Result__Sequence *)allocator.allocate(sizeof(action_server_interface__action__GoTo_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_server_interface__action__GoTo_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_Result__Sequence__destroy(action_server_interface__action__GoTo_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_server_interface__action__GoTo_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_server_interface__action__GoTo_Result__Sequence__are_equal(const action_server_interface__action__GoTo_Result__Sequence * lhs, const action_server_interface__action__GoTo_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_server_interface__action__GoTo_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_server_interface__action__GoTo_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_server_interface__action__GoTo_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_server_interface__action__GoTo_Result * data =
      (action_server_interface__action__GoTo_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_server_interface__action__GoTo_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          action_server_interface__action__GoTo_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!action_server_interface__action__GoTo_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_Feedback * msg = (action_server_interface__action__GoTo_Feedback *)allocator.allocate(sizeof(action_server_interface__action__GoTo_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_server_interface__action__GoTo_Feedback));
  bool success = action_server_interface__action__GoTo_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_Feedback__destroy(action_server_interface__action__GoTo_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    action_server_interface__action__GoTo_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
action_server_interface__action__GoTo_Feedback__Sequence__init(action_server_interface__action__GoTo_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_Feedback * data = NULL;

  if (size) {
    data = (action_server_interface__action__GoTo_Feedback *)allocator.zero_allocate(size, sizeof(action_server_interface__action__GoTo_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_server_interface__action__GoTo_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        action_server_interface__action__GoTo_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
action_server_interface__action__GoTo_Feedback__Sequence__fini(action_server_interface__action__GoTo_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      action_server_interface__action__GoTo_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_Feedback__Sequence * array = (action_server_interface__action__GoTo_Feedback__Sequence *)allocator.allocate(sizeof(action_server_interface__action__GoTo_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_server_interface__action__GoTo_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_Feedback__Sequence__destroy(action_server_interface__action__GoTo_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_server_interface__action__GoTo_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_server_interface__action__GoTo_Feedback__Sequence__are_equal(const action_server_interface__action__GoTo_Feedback__Sequence * lhs, const action_server_interface__action__GoTo_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_server_interface__action__GoTo_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_server_interface__action__GoTo_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_server_interface__action__GoTo_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_server_interface__action__GoTo_Feedback * data =
      (action_server_interface__action__GoTo_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_server_interface__action__GoTo_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          action_server_interface__action__GoTo_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!action_server_interface__action__GoTo_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
action_server_interface__action__GoTo_SendGoal_Request__init(action_server_interface__action__GoTo_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    action_server_interface__action__GoTo_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!action_server_interface__action__GoTo_Goal__init(&msg->goal)) {
    action_server_interface__action__GoTo_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
action_server_interface__action__GoTo_SendGoal_Request__fini(action_server_interface__action__GoTo_SendGoal_Request * msg)
{
  ...
  // goal
  action_server_interface__action__GoTo_Goal__fini(&msg->goal);
}
...
action_server_interface__action__GoTo_SendGoal_Request__are_equal(const action_server_interface__action__GoTo_SendGoal_Request * lhs, const action_server_interface__action__GoTo_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!action_server_interface__action__GoTo_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_SendGoal_Request * msg = (action_server_interface__action__GoTo_SendGoal_Request *)allocator.allocate(sizeof(action_server_interface__action__GoTo_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_server_interface__action__GoTo_SendGoal_Request));
  bool success = action_server_interface__action__GoTo_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_SendGoal_Request__Sequence__init(action_server_interface__action__GoTo_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_SendGoal_Request * data = NULL;

  if (size) {
    data = (action_server_interface__action__GoTo_SendGoal_Request *)allocator.zero_allocate(size, sizeof(action_server_interface__action__GoTo_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_server_interface__action__GoTo_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        action_server_interface__action__GoTo_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
action_server_interface__action__GoTo_SendGoal_Request__Sequence__fini(action_server_interface__action__GoTo_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      action_server_interface__action__GoTo_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_SendGoal_Request__Sequence * array = (action_server_interface__action__GoTo_SendGoal_Request__Sequence *)allocator.allocate(sizeof(action_server_interface__action__GoTo_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_server_interface__action__GoTo_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_SendGoal_Request__Sequence__destroy(action_server_interface__action__GoTo_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_server_interface__action__GoTo_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_server_interface__action__GoTo_SendGoal_Request__Sequence__are_equal(const action_server_interface__action__GoTo_SendGoal_Request__Sequence * lhs, const action_server_interface__action__GoTo_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_server_interface__action__GoTo_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_server_interface__action__GoTo_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_server_interface__action__GoTo_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_server_interface__action__GoTo_SendGoal_Request * data =
      (action_server_interface__action__GoTo_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_server_interface__action__GoTo_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          action_server_interface__action__GoTo_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!action_server_interface__action__GoTo_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
action_server_interface__action__GoTo_SendGoal_Response__init(action_server_interface__action__GoTo_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    action_server_interface__action__GoTo_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_SendGoal_Response * msg = (action_server_interface__action__GoTo_SendGoal_Response *)allocator.allocate(sizeof(action_server_interface__action__GoTo_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_server_interface__action__GoTo_SendGoal_Response));
  bool success = action_server_interface__action__GoTo_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_SendGoal_Response__Sequence__init(action_server_interface__action__GoTo_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_SendGoal_Response * data = NULL;

  if (size) {
    data = (action_server_interface__action__GoTo_SendGoal_Response *)allocator.zero_allocate(size, sizeof(action_server_interface__action__GoTo_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_server_interface__action__GoTo_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        action_server_interface__action__GoTo_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
action_server_interface__action__GoTo_SendGoal_Response__Sequence__fini(action_server_interface__action__GoTo_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      action_server_interface__action__GoTo_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_SendGoal_Response__Sequence * array = (action_server_interface__action__GoTo_SendGoal_Response__Sequence *)allocator.allocate(sizeof(action_server_interface__action__GoTo_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_server_interface__action__GoTo_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_SendGoal_Response__Sequence__destroy(action_server_interface__action__GoTo_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_server_interface__action__GoTo_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_server_interface__action__GoTo_SendGoal_Response__Sequence__are_equal(const action_server_interface__action__GoTo_SendGoal_Response__Sequence * lhs, const action_server_interface__action__GoTo_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_server_interface__action__GoTo_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_server_interface__action__GoTo_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_server_interface__action__GoTo_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_server_interface__action__GoTo_SendGoal_Response * data =
      (action_server_interface__action__GoTo_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_server_interface__action__GoTo_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          action_server_interface__action__GoTo_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!action_server_interface__action__GoTo_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
action_server_interface__action__GoTo_GetResult_Request__init(action_server_interface__action__GoTo_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    action_server_interface__action__GoTo_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_GetResult_Request * msg = (action_server_interface__action__GoTo_GetResult_Request *)allocator.allocate(sizeof(action_server_interface__action__GoTo_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_server_interface__action__GoTo_GetResult_Request));
  bool success = action_server_interface__action__GoTo_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_GetResult_Request__Sequence__init(action_server_interface__action__GoTo_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_GetResult_Request * data = NULL;

  if (size) {
    data = (action_server_interface__action__GoTo_GetResult_Request *)allocator.zero_allocate(size, sizeof(action_server_interface__action__GoTo_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_server_interface__action__GoTo_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        action_server_interface__action__GoTo_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
action_server_interface__action__GoTo_GetResult_Request__Sequence__fini(action_server_interface__action__GoTo_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      action_server_interface__action__GoTo_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_GetResult_Request__Sequence * array = (action_server_interface__action__GoTo_GetResult_Request__Sequence *)allocator.allocate(sizeof(action_server_interface__action__GoTo_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_server_interface__action__GoTo_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_GetResult_Request__Sequence__destroy(action_server_interface__action__GoTo_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_server_interface__action__GoTo_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_server_interface__action__GoTo_GetResult_Request__Sequence__are_equal(const action_server_interface__action__GoTo_GetResult_Request__Sequence * lhs, const action_server_interface__action__GoTo_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_server_interface__action__GoTo_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_server_interface__action__GoTo_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_server_interface__action__GoTo_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_server_interface__action__GoTo_GetResult_Request * data =
      (action_server_interface__action__GoTo_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_server_interface__action__GoTo_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          action_server_interface__action__GoTo_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!action_server_interface__action__GoTo_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
action_server_interface__action__GoTo_GetResult_Response__init(action_server_interface__action__GoTo_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!action_server_interface__action__GoTo_Result__init(&msg->result)) {
    action_server_interface__action__GoTo_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
action_server_interface__action__GoTo_GetResult_Response__fini(action_server_interface__action__GoTo_GetResult_Response * msg)
{
  ...
  // status
  // result
  action_server_interface__action__GoTo_Result__fini(&msg->result);
}
...
action_server_interface__action__GoTo_GetResult_Response__are_equal(const action_server_interface__action__GoTo_GetResult_Response * lhs, const action_server_interface__action__GoTo_GetResult_Response * rhs)
{
  ...
  // result
  if (!action_server_interface__action__GoTo_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_GetResult_Response * msg = (action_server_interface__action__GoTo_GetResult_Response *)allocator.allocate(sizeof(action_server_interface__action__GoTo_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_server_interface__action__GoTo_GetResult_Response));
  bool success = action_server_interface__action__GoTo_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_GetResult_Response__Sequence__init(action_server_interface__action__GoTo_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_GetResult_Response * data = NULL;

  if (size) {
    data = (action_server_interface__action__GoTo_GetResult_Response *)allocator.zero_allocate(size, sizeof(action_server_interface__action__GoTo_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_server_interface__action__GoTo_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        action_server_interface__action__GoTo_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
action_server_interface__action__GoTo_GetResult_Response__Sequence__fini(action_server_interface__action__GoTo_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      action_server_interface__action__GoTo_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_GetResult_Response__Sequence * array = (action_server_interface__action__GoTo_GetResult_Response__Sequence *)allocator.allocate(sizeof(action_server_interface__action__GoTo_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_server_interface__action__GoTo_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_GetResult_Response__Sequence__destroy(action_server_interface__action__GoTo_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_server_interface__action__GoTo_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_server_interface__action__GoTo_GetResult_Response__Sequence__are_equal(const action_server_interface__action__GoTo_GetResult_Response__Sequence * lhs, const action_server_interface__action__GoTo_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_server_interface__action__GoTo_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_server_interface__action__GoTo_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_server_interface__action__GoTo_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_server_interface__action__GoTo_GetResult_Response * data =
      (action_server_interface__action__GoTo_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_server_interface__action__GoTo_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          action_server_interface__action__GoTo_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!action_server_interface__action__GoTo_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
action_server_interface__action__GoTo_FeedbackMessage__init(action_server_interface__action__GoTo_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    action_server_interface__action__GoTo_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!action_server_interface__action__GoTo_Feedback__init(&msg->feedback)) {
    action_server_interface__action__GoTo_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
action_server_interface__action__GoTo_FeedbackMessage__fini(action_server_interface__action__GoTo_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  action_server_interface__action__GoTo_Feedback__fini(&msg->feedback);
}
...
action_server_interface__action__GoTo_FeedbackMessage__are_equal(const action_server_interface__action__GoTo_FeedbackMessage * lhs, const action_server_interface__action__GoTo_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!action_server_interface__action__GoTo_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_FeedbackMessage * msg = (action_server_interface__action__GoTo_FeedbackMessage *)allocator.allocate(sizeof(action_server_interface__action__GoTo_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_server_interface__action__GoTo_FeedbackMessage));
  bool success = action_server_interface__action__GoTo_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_FeedbackMessage__Sequence__init(action_server_interface__action__GoTo_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_FeedbackMessage * data = NULL;

  if (size) {
    data = (action_server_interface__action__GoTo_FeedbackMessage *)allocator.zero_allocate(size, sizeof(action_server_interface__action__GoTo_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_server_interface__action__GoTo_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        action_server_interface__action__GoTo_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
action_server_interface__action__GoTo_FeedbackMessage__Sequence__fini(action_server_interface__action__GoTo_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      action_server_interface__action__GoTo_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_server_interface__action__GoTo_FeedbackMessage__Sequence * array = (action_server_interface__action__GoTo_FeedbackMessage__Sequence *)allocator.allocate(sizeof(action_server_interface__action__GoTo_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_server_interface__action__GoTo_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
action_server_interface__action__GoTo_FeedbackMessage__Sequence__destroy(action_server_interface__action__GoTo_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_server_interface__action__GoTo_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_server_interface__action__GoTo_FeedbackMessage__Sequence__are_equal(const action_server_interface__action__GoTo_FeedbackMessage__Sequence * lhs, const action_server_interface__action__GoTo_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_server_interface__action__GoTo_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_server_interface__action__GoTo_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_server_interface__action__GoTo_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    action_server_interface__action__GoTo_FeedbackMessage * data =
      (action_server_interface__action__GoTo_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_server_interface__action__GoTo_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          action_server_interface__action__GoTo_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!action_server_interface__action__GoTo_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
